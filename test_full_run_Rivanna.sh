...
# SIM_NAME=/scratch/xpz5km/vcell_out/_04_15_24_TEST_CPC_tensed_RefModel_128x64_to_omex_SBML_units/simulations/_10_16_23_tensed_RefModel_Mps1_phos_Plk1a_20Pac_transactiv/
# echo "$SIM_NAME"
# DATA=${SIM_NAME}
