...
def convert_h5_to_csvs_Logan_results(
    dir_path,
    model_name,
    sedml_name,
    file_name="reports.h5",
    ...
    if len(species_list) == 0:
        default_species = ["Bub1a","Bub1a_his","CPCa", "CPCi","H2A","H3","Haspina","Haspini","Knl1","Mps1a","Mps1i","Ndc80","Ndc80_Mps1a","Ndc80_Mps1i","Ndc80_pMps1a","Ndc80_pMps1i","pH2A","pH2A_Sgo1","pH2A_Sgo1_CPCa","pH2A_Sgo1_CPCi","pH2A_Sgo1_pH3_CPCa","pH2A_Sgo1_pH3_CPCi","pH3","pH3_CPCa","pH3_CPCi","pKnl1","pKnl1_Bub1a","Plk1a","Plk1i","pMps1a","pMps1i","pNdc80","pNdc80_Mps1a","pNdc80_Mps1i","pNdc80_pMps1a","pNdc80_pMps1i","Sgo1",]
    ...
    with h5py.File(f"{dir_path}/{file_name}", "r") as h5:
        ...
        for simulation_name in simulation_names:
            ...
            ndim = h5[f"{sedml_name}.sedml"][f"report_{simulation_name}"].ndim
            if ndim == 6:
                print("6D array found, reading in parameter scan")
                for p in range(
                    h5[f"{sedml_name}.sedml"][f"report_{simulation_name}"].shape[1]
                ):
                    output_folder = f"{dir_path}/simulations/{simulation_name}_scan{p}/data/"
                ...
                for k, key in enumerate(species):
                    if key in default_species:
                        # print(key)
                        arr = h5[f"{sedml_name}.sedml"][f"report_{simulation_name}"][ k, :,1, :, :]
                        # sns.heatmap(arr, vmin = 0, cmap = 'Blues', square = True, )
                        # plt.title(key)
                        # plt.show()
                        for i in range(arr.shape[2]):
...
def convert_h5_to_csvs_updated(
    dir_path,
    model_name,
    sedml_name,
    file_name="reports.h5",
    ...
    if len(species_list) == 0:
        # default_species = ["Bub1a","Bub1a_his","CPCa", "CPCi","H2A","H3","Haspina","Haspini","Knl1","Mps1a","Mps1i","Ndc80","Ndc80_Mps1a","Ndc80_Mps1i","Ndc80_pMps1a","Ndc80_pMps1i","pH2A","pH2A_Sgo1","pH2A_Sgo1_CPCa","pH2A_Sgo1_CPCi","pH2A_Sgo1_pH3_CPCa","pH2A_Sgo1_pH3_CPCi","pH3","pH3_CPCa","pH3_CPCi","pKnl1","pKnl1_Bub1a","Plk1a","Plk1i","pMps1a","pMps1i","pNdc80","pNdc80_Mps1a","pNdc80_Mps1i","pNdc80_pMps1a","pNdc80_pMps1i","Sgo1",]
        new_default =     ["Haspini","Haspina","Plk1a","H3","pH3","pKnl1","pKnl1_Bub1a","Bub1a","H2A","pH2A","Bub1a_his","Sgo1","pH2A_Sgo1","CPCi","pH3_CPCi","pH2A_Sgo1_CPCi","CPCa","pH3_CPCa","pH2A_Sgo1_CPCa","Plk1i",'Mps1i',"pMps1i",'Mps1a',"pMps1a",'Ndc80',"pNdc80",'Ndc80_Mps1i',"Ndc80_pMps1i","pNdc80_pMps1i","pNdc80_Mps1i","Ndc80_Mps1a","Ndc80_pMps1a","pNdc80_pMps1a","pNdc80_Mps1a",'Knl1','Sgo1_CPCi','Sgo1_CPCa',"H3_CPCi","H3_CPCa"]
        default_species = new_default
        print(f"Using default species list of length {len(default_species)}")
    else:
        default_species = species_list
        print(f"Using species list of length {len(default_species)}")
...
if __name__ == "__main__":
    ...
    if logan:
        convert_h5_to_csvs_updated(dir_path=dir_path, model_name=model_name, sedml_name = sedml_name)
    else:
